...
## 1.1 Развёртывание программного окружения

## 1.2 Установка среды контейнеризации Docker
...
## 1.3 Развёртывание маршрутизатора входящих запросов Traefik
...
## 1.4 Подготовка конфигурационных файлов
...
## 1.5 Создание вспомогательных файлов
...
## 1.6 Установка и подготовка PostgreSQL
...
## 1.7 Подготовка постоянного хранилища
...
## 1.9 Запуск Комплекса

## 1.10 Загрузка через командную строку
